...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="ad_asset/vendors/css/vendor.bundle.base.css">
    <!-- endinject -->
    <!-- Plugin css for this page -->
    <link rel="stylesheet" href="ad_asset/vendors/font-awesome/css/font-awesome.min.css" />
    <link rel="stylesheet" href="ad_asset/vendors/bootstrap-datepicker/bootstrap-datepicker.min.css">
  ...
  <body>
          ...
          <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item nav-profile dropdown">
              ...
              <div class="dropdown-menu navbar-dropdown dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="profileDropdown" data-x-placement="bottom-end">
                <div class="p-3 text-center bg-primary">
                  <img class="img-avatar img-avatar48 img-avatar-thumb" src="ad_asset/images/faces/face28.png" alt="">
                </div>
                <div class="p-2">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="ad_asset/images/faces/face3.jpg" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="http://127.0.0.1:8000/admin/classes" target="_blank">View Class</a></li>
                  <li class="nav-item"> <a class="nav-link" href="http://127.0.0.1:8000/admin/classes/add?ref=T1yjovO" target="_blank">Add Class</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://127.0.0.1:8000/admin/categories" target="_blank">
                <span class="icon-bg"><i class="mdi mdi-contacts menu-icon"></i></span>
                <span class="menu-title">Categories</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://127.0.0.1:8000/admin/books" target="_blank">
            ...
            <li class="nav-item">
              <a class="nav-link" href="http://127.0.0.1:8000/admin/messages" target="_blank">
                <span class="icon-bg"><i class="mdi mdi-table-large menu-icon"></i></span>
    ...
    <!-- container-scroller -->
    <!-- plugins:js -->
    <script src="ad_asset/vendors/js/vendor.bundle.base.js"></script>
    <!-- endinject -->
    <!-- Plugin js for this page -->
    <script src="ad_asset/vendors/chart.js/Chart.min.js"></script>
    <script src="ad_asset/vendors/jquery-circle-progress/js/circle-progress.min.js"></script>
    <!-- End plugin js for this page -->
    <!-- inject:js -->
    <script src="ad_asset/js/off-canvas.js"></script>
    <script src="ad_asset/js/hoverable-collapse.js"></script>
    <script src="ad_asset/js/misc.js"></script>
    <!-- endinject -->
    <!-- Custom js for this page -->
    <script src="ad_asset/js/dashboard.js"></script>
